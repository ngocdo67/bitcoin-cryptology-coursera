...
public class Block {
    ...
    public String toString() {
        return "Block: Hash: " + (hash == null ? "null" : hash.toString()) + " Prev block hash: " + (prevBlockHash == null ? "null" : prevBlockHash.toString())
        + " Coinbase: " + (coinbase == null ? "null" : coinbase.toString()) + " Txs: " + (txs == null ? "null" : txs.toString());
    }
